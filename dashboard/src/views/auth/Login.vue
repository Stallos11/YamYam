  ...
  <div class="card bg-dark rounded-2 overflow-visible mt-4 light-shadow-4 mb-4">
    ...
    <div class="card-content">
      <div class="text-center">
        <router-link to="/register" class="text-primary font-w500"
          >Don't have an account ? Create it now !</router-link
        >
      </div>
      ...
      <div class="text-center mt-3">
        <router-link to="/forgot-password" class="text-grey text-light-2"
    ...
    <div class="card-footer pb-0 px-0">
      <ax-btn
        class="w100 primary d-flex fx-center vcenter"
        @click="login"
