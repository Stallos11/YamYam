  ...
  <ax-modal class="bg-dark rounded-1 shadow-1 h100" v-model="userStore.isModalOpened">
    ...
    <div>
      ...
      <div v-if="userStore.selectedUser.recipes?.length" class="grix xs1 lg2 p-3 gutter-xs5">
        <div v-for="recipe in userStore.selectedUser.recipes" :key="recipe.id" class="card shadow-1 fx-row">
          <img class="rounded-3" src="https://picsum.photos/200/100" />
          <div class="d-flex fx-col fx-grow">
            ...
            <div class="grix xs2 center">
              <div class="d-flex fx-center vcenter">
                <Icon class="cursor-pointer mr-1" icon="mdi:eye-outline" size="50"></Icon>
                123
              </div>
              <div>
                <Icon class="cursor-pointer mr-1" icon="mdi:cards-heart-outline" size="50"></Icon>
                33
              </div>
              <div>
                <Icon class="cursor-pointer mr-1" icon="iconoir:stat-up" size="50"></Icon>
                33
              </div>
              <div>
                <Icon class="cursor-pointer mr-1" icon="material-symbols:ios-share-rounded" size="50"></Icon>
                76
              </div>
            </div>
          </div>
