        ...
        <div class="tab-left">
            <ax-form class="">
                <div class="grix xs1 md2 gutter-xs5 p-5">
                    ...
                    <div>
                        <Timepicker :label="'Temps de préparation'"
                    ...
                    <div>
                        <ax-form-field label="Eaters amount">
                            <ax-form-control tag="input" v-model="recipeStore.recipeCreate.recipe.eaters_amount"
                                type="number" min="0" class="mb-5"></ax-form-control>
                        </ax-form-field>
                    </div>
                    <div>
